  ...
  return (
    <div className='container flex flex-col items-start justify-center w-full  max-h-screen h-[500px]'>
      ...
      <div className='w-full flex items-center justify-center mt-5'>
        <Link href="/" className='submit-button hover:border-white text-center border border-[#e536ab] text-black transition-all duration-300 rounded-full hover:text-white text-xs font-light w-full md:w-auto py-3 px-7 mt-5 uppercase'>
          Get Started
        </Link>
      </div>
